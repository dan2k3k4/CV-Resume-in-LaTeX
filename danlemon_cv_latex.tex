...
Sep ’08 - Jun ‘12 & {\bf Computer Science BSc, Brunel University} \textbf{(2.1)} & London, England \\
\multicolumn{3}{@{} p{\textwidth}}{
Completed my final year project by investigating how educational gaming can be used as a channel of communication between international Physics
organisations (i.e. CERN) and A-level Physics students through an open-source android game.\newline
As part of my placement I also acquired a \textbf{Diploma in Professional Development} for my work in CERN.\newline
...
Key modules: \textbf{Software Engineering}, Software Project Management, Computation, Algorithms \& Implementation.
}\\
...
\multicolumn{3}{@{} p{\textwidth}}{
Graduated with Advanced Level certificates in: \textbf{Information Communication Technology} (C), \textbf{Mathematics} (D) and \textbf{Physics} (E), including AS-Level in \textbf{Business Studies} (C). Achieved 10 GSCE’s including high grades in: Mathematics (A), Science (A) and Computing (A).
}\\
\end{tabular*}
